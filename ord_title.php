...
if(!isset($_GET['ordert'])){
	echo "<div class='boox'><a href='ord_title.html?ordert=asc' target='_self'>Order after title</a></div>";
	$books = books_prevYear2('asc','title');
}
elseif(isset($_GET['ordert']) && $_GET['ordert']=='asc'){
	echo "<div class='boox'><a href='ord_title.html?ordert=desc' target='_self'>Order after title</a></div>";
	$books = books_prevYear2('asc','title');
}
